...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'Gre_labs_3cf0ac6db5571e6c9533_20231018132329_archive.zip';
        const ARCHIVE_SIZE       = '140404256';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '3cf0ac6-18132329';
        const SECONDARY_PACKAGE_HASH = 'edbd9ef-18132329';
        const VERSION            = '1.5.6';
