				...
				foreach ( $social_networks as $link ) {
					switch ( $link ) {
						case 'facebook':
							...
							break;
						case 'twitter':
							echo '<a class="-unlink" href="' . $twitter_link . '" target="' . $target_blank . '"><i class="network fab fa-x-twitter"></i></a>';
							break;
						case 'linkedin':
				...
				foreach ( $social_networks as $link ) {
					switch ( $link ) {
						case 'facebook':
							...
							break;
						case 'twitter':
							echo '<a href="' . $twitter_link . '" target="' . $target_blank . '" class="twitter network"><i class="fab fa-x-twitter"></i></a>';
							break;
						case 'linkedin':
