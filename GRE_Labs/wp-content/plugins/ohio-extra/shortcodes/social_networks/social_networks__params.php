	...
	return array(
		...
		'params' => array(
			...
			array(
				'type' => 'ohio_check',
				'group' => __( 'Links', 'ohio-extra' ),
				'heading' => '<i class="fab fa-x-twitter"></i> ' . __( 'Twitter share', 'ohio-extra' ),
				'param_name' => 'twitter',
				'value' => array(
					__( 'Enable', 'ohio-extra' ) => '1'
				),
			...
			array(
				'type' => 'textfield',
				'group' => __( 'Links', 'ohio-extra' ),
				'heading' => '<i class="fab fa-telegram"></i> ' . __( 'Telegram', 'ohio-extra' ),
			...
			array(
				'type' => 'textfield',
				'group' => __( 'Links', 'ohio-extra' ),
				'heading' => '<i class="fab fa-threads"></i> ' . __( 'Threads', 'ohio-extra' ),
			...
			array(
				'type' => 'textfield',
				'group' => __( 'Links', 'ohio-extra' ),
				'heading' => '<i class="fab fa-x-twitter"></i> ' . __( 'Twitter', 'ohio-extra' ),
